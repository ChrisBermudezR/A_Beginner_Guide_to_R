...
#it. The following code uses functions from other chapters….but it is useful once
...
#The ISIT file we gave you already contained this info…but let's do it again.
...
#Problem…now you need to convert this into a matrix using the correct (!!!) order of the months and years
...
#There is a hidden slash after Indonisia….delete it and save the file
...
## |Extra stuff….not part of the exercises
